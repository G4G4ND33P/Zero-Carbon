                ...
                <section class="hero">
                    <div class="container">
                        <div class="hero-inner">
                            <div class="hero-copy">
                                <h1 class="hero-title mt-0">Zero Carbon</h1>
                                <p class="hero-paragraph">Scan and Earn Token Rewards</p>
                                <div class="hero-cta">
                                    <a class="button button-primary" href="#" @click.prevent="goToDashboard">Get Started</a>
                                </div>
                            </div>
                                ...
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        <div class="feature-icon">
                                            <img src="../images/barcode.svg" alt="Feature 01">
                                        </div>
                                        <h4 class="feature-title mt-24">Scan barcode</h4>
                                        <p class="text-sm mb-0">Scan the item or enter the barcode manually to search from a wide range of products. The more you scan the more you earn.</p>
                                    </div>
                                </div>
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        <div class="feature-icon">
                                            <img src="../images/earnzc.svg" alt="Feature 02">
                                        </div>
                                        <h4 class="feature-title mt-24">Earn ZC</h4>
                                        <p class="text-sm mb-0">Submit the product. Once verified, ZC tokens will be added to your account.</p>
                                    </div>
                                </div>
                                <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
                                        <div class="feature-icon">
                                            <img src="../images/userrewards.svg" alt="Feature 03">
                                        </div>
                                        <h4 class="feature-title mt-24">Use Rewards</h4>
                                        <p class="text-sm mb-0">Exchange your ZC token rewards to get Ether. Ether gets deposited to your account.</p>
                                    </div>
                                </div>
                                <!-- <div class="feature text-center is-revealing">
                                    <div class="feature-inner">
            ...
            <footer class="site-footer">
                <div class="container">
                    <div class="site-footer-inner">
                        ...
                        <div class="footer-copyright">&copy; 2020 ZeroCarbon, all rights reserved</div>
                    </div>
                </div>
            </footer>
        </div>
...
export default {
    ...
    mounted(){
        ...
        anime({
            ...
            duration: anime.random(4000, 5000),
